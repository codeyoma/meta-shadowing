...
The configured remote is `origin` at `https://github.com/codeyoma/meta-shadowing.git`. The `gh` CLI resolves this repository automatically when commands run inside this clone.
