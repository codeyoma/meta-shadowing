...
| Typography | Legible bilingual sans serif; first hint at least 64px | Sans serif and 64px hints retained. Bounded scrollable long-text canvas and whole-word Korean control wrapping prevent unreadable overflow. The concept's serif `I` is not used because the written contract requires sans serif. |
