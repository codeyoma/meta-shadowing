...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "font-heading text-xl leading-snug font-bold text-display",
        className
      )}
      {...props}
    />
