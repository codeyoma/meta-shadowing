...
export default function BrowsingTabs() {
  ...
  return <NativeTabs backgroundColor={c.background} tintColor={c.heading}
    screenListeners={{ tabPress: event => { if (!event.data.isPrevented) tapFeedback(); } }}
    ...
    <NativeTabs.Trigger name="index" accessibilityLabel="도서 선택" contentStyle={{ backgroundColor: c.background }} disableTransparentOnScrollEdge>
    ...
    <NativeTabs.Trigger name="lesson" accessibilityLabel="스테이지" contentStyle={{ backgroundColor: c.background }} disableTransparentOnScrollEdge>
      <NativeTabs.Trigger.Icon sf={{ default: 'map', selected: 'map.fill' }} md="map" />
      <NativeTabs.Trigger.Label hidden>스테이지</NativeTabs.Trigger.Label>
    </NativeTabs.Trigger>
    <NativeTabs.Trigger name="settings" accessibilityLabel="설정" contentStyle={{ backgroundColor: c.background }} disableTransparentOnScrollEdge>
